...
`ATLASCOM_TIER_CODE` is optional. When it is unset, Atlascom receives `6666` for both `codeTiers` and `codeClient`; set it only when Atlascom provides a distinct tier code. No customer delivery data is exported.
