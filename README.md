...
`ATLASCOM_TIER_CODE` is optional. Leave it unset unless Atlascom provides a distinct tier code; `codeClient` is sent as `6666` and no customer delivery data is exported.
