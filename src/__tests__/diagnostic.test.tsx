...
const mockProducts = [
  {
    ...
    routineRoles: ['cleanser'] as const,
    suitableSkinTypes: ['oily'] as const,
    suitableConcerns: ['acne'] as const,
    sensitivityLevels: ['high'] as const,
    activeStrength: 'gentle' as const,
    timeOfDay: ['morning', 'evening'] as const,
  },
  {
    id: 22,
    ...
    suitableSkinTypes: ['oily'] as const,
    suitableConcerns: ['acne'] as const,
    sensitivityLevels: ['medium'] as const,
    activeStrength: 'moderate' as const,
    timeOfDay: ['morning', 'evening'] as const,
  },
  {
    id: 3,
    ...
    stock: 10,
    status: 'live' as const,
    routineRoles: ['treatment'] as const,
    suitableSkinTypes: ['oily'] as const,
    suitableConcerns: ['dullness'] as const,
    sensitivityLevels: ['medium'] as const,
    activeStrength: 'moderate' as const,
  ...
  },
  {
    ...
    stock: 10,
    status: 'live' as const,
    routineRoles: ['sunscreen'] as const,
    suitableSkinTypes: ['oily'] as const,
    suitableConcerns: ['sun_protection', 'acne'] as const,
    sensitivityLevels: ['high'] as const,
    activeStrength: 'none' as const,
    timeOfDay: ['morning'] as const,
  },
];
