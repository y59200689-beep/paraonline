...
export default async function Home() {
  ...
  const rawSectionsList = hp.sectionOrder 
    ? hp.sectionOrder.filter((s: any) => s.type !== 'flashSale' && s.type !== 'curationClinique' && s.type !== 'skinConcerns' && s.type !== 'ingredientDictionary' && s.type !== 'horizontalPromo' && s.type !== 'weeklySales')
