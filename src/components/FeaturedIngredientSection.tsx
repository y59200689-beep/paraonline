...
const BRANDS = [
  {
    ...
    image: '/images/cerave_showcase_banner.webp',
    href: '/brand/cerave',
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10 items-stretch">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/50 to-transparent flex flex-col justify-end p-6 md:p-8">
          <div className="space-y-3">
            ...
            <div className="pt-2">
              <span className="public-cta-secondary inline-flex items-center gap-1.5 rounded-full bg-white px-5 py-2.5 text-xs font-bold text-slate-950 shadow-md transition-all duration-200 group-hover:scale-105 group-hover:bg-slate-100 group-active:scale-95">
      ...
      <div className="lg:col-span-2 flex flex-col">
        ...
        <div
          ref={scrollRef}
          className="flex gap-3 sm:gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-none pb-4 flex-1"
        >
          {loading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="snap-start shrink-0 w-[112px] sm:w-[150px] lg:w-[150px] xl:w-[160px] animate-pulse">
                <div className="bg-slate-100 dark:bg-slate-900/60 rounded-xl h-[180px] sm:h-[260px]" />
              </div>
            ))
