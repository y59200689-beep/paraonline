...
const LRP_CONFIG = {
  ...
  introduction: 'Explorez des routines ciblées pour les imperfections, la protection solaire, la réparation et l’hydratation, avec une sélection disponible chez Para Divine.',
  metrics: [
...
const VICHY_CONFIG = {
  ...
  footnote: 'Sélection et disponibilité mises à jour depuis le catalogue Para Divine.',
...
const CERAVE_CONFIG = {
  ...
  introduction: 'Nettoyez, hydratez et protégez votre peau avec des soins CeraVe classés par besoin et disponibles chez Para Divine.',
  metrics: [
...
const AVENE_CONFIG = {
  ...
  introduction: 'Explorez les soins Avène par besoin : imperfections, hydratation, réparation, sécheresse, sensibilité et protection solaire chez Para Divine.',
  metrics: [
