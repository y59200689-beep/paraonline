                  ...
                  {replyingReviewId === rev.id && (
                    <form onSubmit={handleReplySubmit} className="space-y-2 pt-2 animate-scale-up">
                      ...
                      <div className="flex gap-2 justify-end">
                        ...
                        <button
                          type="submit"
                          className="px-4 py-1.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black rounded-xl text-[10px] uppercase tracking-wider shadow-md transition"
                        >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isPending && (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider bg-emerald-500 text-slate-950 hover:bg-emerald-400 shadow-md transition cursor-pointer"
                      >
                        <CheckCircle className="w-3.5 h-3.5" />
                        Approuver
                      </button>
