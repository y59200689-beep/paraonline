    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex gap-2 pt-2">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 py-3 border border-slate-200 text-slate-500 hover:text-slate-800 rounded-[11px] text-xs font-black uppercase tracking-wider transition-colors"
        >
          Retour
        </button>
        <button
          ...
          className="flex-1 py-3 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-black uppercase tracking-wider rounded-[11px] transition-all shadow-md flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
        >
