...
REVOKE ALL ON FUNCTION public.award_order_loyalty_once(TEXT, TEXT) FROM PUBLIC;
...
-- This is the final persistence boundary: the order, stock decrement, and COD
-- loyalty award occur within the same database transaction.
